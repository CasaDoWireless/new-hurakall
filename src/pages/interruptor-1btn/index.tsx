    ...
    <>
      ...
      <FirstSection>
        <div className="section1">
          <img src="/assets/home/produtos_home/1btn.png" alt="" />
        </div>
      </FirstSection>
      ...
      <ThirdSection>
        ...
        <div className="img1">
          <img src="/assets/touch6btn/btn1.png" alt="touch-light-hurakall"/>
        </div>
      </ThirdSection>
      ...
      <FouthSection>
        ...
        <div className="two">
          <img src="/assets/touch6btn/image-touch1btn.png" alt="" />
        </div>
        <p className="desc">
      ...
      <SixthSection>
        ...
        <p>INTERRUPTOR TOUCH WI-FI 1 BOTÃO</p>
        <table>
          <tbody>
            <tr>
